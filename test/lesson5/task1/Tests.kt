...
class Tests {
    ...
    @Tag("Normal")
    fun bestLongJump() {
        assertEquals(2147483647, bestLongJump("%   593081463 - % - 1066548542 - 1079307515 0 -  - 0 -  - 1 973025546   2147483647 0  2147483647     - -   %   1  1 - -   -   % -  321738215 2147483647 %  % - %  %   2147483647 711083610 1    - - % % - % 593470316 % - - 585413364"))
    ...
    @Tag("Hard")
    fun bestHighJump() {
        assertEquals(633411155, bestHighJump("1 + 906735417 %- 147483648 + 1 %%- 174090972 + 0 %- 66514559 %%- 633411155 %%+ 457289277 + 147483648 %%+ 0 + 147483648 %%- 147483647 %%- 1 %%- 1 %%+ 0 + 1 + 1 %%- 1 %+ 147483648 +"))
